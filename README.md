...
3. Run `maintenance/run.php update`, which will create the database table necessary for the extension to run.
4. Add `wfLoadExtension( 'WikiPoints' );` to LocalSettings.php.
5. You're done!
